 ...
 * The maximum size of the cache, in bytes.
 */
@property (assign, nonatomic) NSUInteger maxOfflineCacheSize;
/**
 * The maximum size of the cache, in bytes.
 */
@property (assign, nonatomic) NSUInteger maxHomePageCacheSize;
/**
 * The maximum size of the cache, in bytes.
 */
@property (assign, nonatomic) NSUInteger maxWatchCacheSize;
 ...
 *
 * @param key The unique key used to store the wanted image
 * @param needSmallCopy if needSmallCopy is YES, it will return a small copy of an image if no bigger exists, you can use it as a placeholder
 */
- (NSOperation *)queryDiskCacheForKey:(NSString *)key
                        needSmallCopy:(BOOL)needSmallCopy
